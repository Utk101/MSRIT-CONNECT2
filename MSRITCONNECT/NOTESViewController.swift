...
class NOTESViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.register(CellClass1.self, forCellReuseIdentifier: "cell")
    ...
    func addTransparentView(frames: CGRect)
{
    ...
    UIView.animate(withDuration: 0.4, delay: 0.0, usingSpringWithDamping: 1.0, initialSpringVelocity: 1.0,options: .curveEaseInOut, animations: {self.transparentView.alpha = 0.5
        self.tableView.frame = CGRect(x: 0, y: frames.origin.y + frames.height+5, width: 500, height: 50)
    }, completion: nil)
